...
(cl-defun muki:init-evil-surround ()
  (req 'evil-surround
    ...
    (hook 'perl-mode-hook #'evil-surround-mode)
    (hook 'cperl-mode-hook #'evil-surround-mode)
    ...
    (hook 'perl-mode-hook #'muki:evil-surround-replace-all-pairs)
    (hook 'cperl-mode-hook #'muki:evil-surround-replace-all-pairs)
    ))
