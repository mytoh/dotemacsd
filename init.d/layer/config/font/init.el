...
(cl-defun muki:set-up-yuki-ligature ()
  ;; [[https://github.com/tonsky/YukiCode/wiki/Setting-up-Emacs]]

;;; Yuki code
  ;; This works when using emacs --daemon + emacsclient
  (add-hook 'after-make-frame-functions (lambda (frame) (set-fontset-font t '(#Xe100 . #Xe16f) "Yuki Code Symbol")))
  ;; This works when using emacs without server/client
  (set-fontset-font t '(#Xe100 . #Xe16f) "Yuki Code Symbol")
  ;; I haven't found one statement that makes both of the above situations work, so I use both for now

  (defconst yuki-code-font-lock-keywords-alist
  ...
  (defun add-yuki-code-symbol-keywords ()
    (font-lock-add-keywords nil yuki-code-font-lock-keywords-alist))

  (add-hook 'prog-mode-hook
            #'add-yuki-code-symbol-keywords)
