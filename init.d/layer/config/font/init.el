...
(cl-defun set-ascii-font ()
  (cond ((null window-system) nil)
        ((font-exists-p "Fantasque Sans Mono")
         (set-fontset-font nil 'ascii (font-spec :name  "Fantasque Sans Mono" :size 12)))
        ((font-exists-p "Fantasque Sans Mono Migu 1M")
         (set-fontset-font nil 'ascii (font-spec :name  "Fantasque Sans Mono Migu 1M" :size 12)))
        ((font-exists-p "mononoki")
         (set-fontset-font nil 'ascii (font-spec :name  "mononoki" :size 11)))
        ((font-exists-p "Hack")
         (set-fontset-font nil 'ascii (font-spec :name  "Hack" :size 11)))
        ((font-exists-p "SF Mono")
         (set-fontset-font nil 'ascii (font-spec :name  "SF Mono" :size 10)))
        ((font-exists-p "Cica")
         (set-fontset-font nil 'ascii (font-spec :name  "Cica" :size 12)))
  ...
  (cond ((null window-system) nil)
        ((font-exists-p "Cica")
         (set-fontset-font t 'japanese-jisx0208
                           (font-spec :name  "Cica" :size 11 :weight 'normal))
