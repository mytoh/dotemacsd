...
(cl-defun elnode-org-handler (httpcon)
  (elnode-docroot-for (expand-file-name "etusivu/etusivu.org"
                                        org-directory)
      with org-file
      on httpcon
...
(cl-defun elnode-org-update-handler (httpcon)
...
replacement."
  (elnode-method httpcon
    (POST
     (cl-letf* ((file-name (elnode-http-param httpcon "file-name"))
...
(cl-defun elnode-org--update (file-name node-match in-node-match replace-match)
